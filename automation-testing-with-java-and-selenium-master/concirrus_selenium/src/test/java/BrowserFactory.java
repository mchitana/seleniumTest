    ...
    public static WebDriver startBrowser(String browserName, String url){
        if(driver==null){
            if(browserName.equalsIgnoreCase("firefox")){
                Path firefox = Paths.get("./src/main/resources/firefoxdriver/geckodriver");
                firefox.toFile().setExecutable(true);
                System.setProperty("webdriver.chrome.driver", firefox.toAbsolutePath().toString());
                ...
                System.setProperty("webdriver.chrome.driver", ie.toAbsolutePath().toString());
